...
Battery state of charge (%) | GET | /battery-percent | `curl http://192.168.9.1:8000/battery-percent` | Success: Battery state of charge percent, 200. Failure: "Failed to read battery percentage", 500. | Percent is rounded to 2 decimal places, e.g. `87.34`, with no percent sign. May exceed 100.
